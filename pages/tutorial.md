...
### CANCELED [#C] Write a page with more than 1000 blocks
## That's it! Thanks for your time and having fun!
### NOW [#A] Check out this awesome video by [:a {:href "https://twitter.com/EdTravelling" :target "_blank"} "@EdTravelling"], which shows how to install logseq app on your GitHub repo and other cool features like graph view.
